...
namespace WowPacketParserModule.V5_5_0_61735.Parsers
{
    public static class CombatLogHandler
    {
        ...
        public static void HandleAttackswingLandedLog(Packet packet)
        {
            ...
            // The landed log repeats a swing the state update already reported.
            var round = Opcodes.GetOpcode(packet.Opcode, packet.Direction) == Opcode.SMSG_ATTACKER_STATE_UPDATE
                ? packet.Holder.AttackerStateUpdate = new()
                : null;
            ReadAttackRoundInfo(packet, round, "AttackRoundInfo");
        }
